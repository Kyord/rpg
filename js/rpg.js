...
var playerImageR = "img/player-r"+indexSPR+".png";
var playerImageL = "img/player-l1.png";
...
enemyImage.src = "img/enemy-r.png";
//END-SPRITES
...
var setLevel = function() {
	...
	time = (2 * level) * timeEachEnemy + extraTime;
	base_floor = getBaseFloor();
	player.y, enemy.y = base_floor;
	bgImage.src = "img/wallpaper"+levelIndex+".png";
}
...
var update = function(delta) {//up=38, down=40, left=37, right=39
	...
	if((37 in keysDown || 65 in keysDown) && player.x > 0) {//LEFT
		...
		playerImageC.src = "img/player-l"+Math.floor(indexSPR)+".png";
	}
	if((39 in keysDown || 68 in keysDown) && player.x < (canvas.width - 25)) {//RIGHT
		player.x += player.spd_x * delta;
		playerImageC.src = "img/player-r"+ Math.floor(indexSPR) +".png";
	}
